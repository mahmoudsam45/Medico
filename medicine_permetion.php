    ...
    <ul class="sidebar-menu ">
      ...
      <li class="active">
        ...
        <ul class="menu-dropdown ">
          ...
          <li class="active"><a href="medicine_permetion.php" style="text-align: right;"><i class="ion ion-ios-circle-outline" style="float: right; margin-left:10px"></i> اذن أدوية</a></li>
                ...
                <select class="form-control" name="matname" placeholder="اختر اسم المادة" style=" text-align:right">
                  ...
                  if (isset($_POST["adddd"])) {
                    ...
                    if (isset($_POST["out"]))
                      ...
                      $type = "إذن مجانى";
                    $perm = new medicineperm();
                    $perm->setpermtype($type);
                    $perm->setmedname($_POST["matname"]);
                    $perm->setquant($_POST["quan"]);
                    $perm->setdate($_POST["stdat"]);
                    $perm->Add();
                    $dir = "permetionimage/";
              ...
              <div class="table-responsive">
                <form method="post">
                  <table class="table table-bordered table-striped" style="text-align: right;">
                    ...
                    ?>
                      <tr>
                        <td><input type="submit" name="btn<?php echo $row["medperm"]; ?>" value="حذف" class="btn btn-danger" /> </td>
                      ...
                      if (isset($_POST["btn" . $row["medperm"]])) {
                        $del = new medicineperm();
                        $_SESSION["dell"] = $row["medperm"];
                        $del->Delete();
